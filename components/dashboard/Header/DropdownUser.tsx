  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        className={`absolute -right-16 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark ${
          dropdownOpen === true ? "block" : "hidden"
        }`}
      >
        <ul className="flex flex-col gap-5 border-b border-stroke px-4 py-7.5 dark:border-strokedark">
          <li>
            {admin ? (
              <>
