      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-indigo/50 dark:text-white font-bold mb-2">Products</h6>
          ...
          {/* 3rd block */}
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-indigo/50 dark:text-white font-bold mb-2">Resources</h6>
            <ul className="text-sm">
              <li className="mb-2">
          ...
          {/* 4th block */}
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-indigo/50 dark:text-white font-bold mb-2">Company</h6>
            <ul className="text-sm">
              <li className="mb-2">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          <div className="text-sm text-gray-600 mr-4 flex ">
            ...
            <span className="block md:hidden pl-1">SSFF</span>
            . All rights reserved.
          </div>
